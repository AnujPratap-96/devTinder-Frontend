...
const CompactUserItem = memo(
  ({ user, onView, searchQuery = "" }) => {
    const photo = optimizePhotoUrl(Array.isArray(user.photoUrl) ? user.photoUrl[0] : (user.photoUrl || user.photo));
...
CompactUserItem.displayName = "CompactUserItem";
