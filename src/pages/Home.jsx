...
const testimonials = [
  {
    ...
    text: "DevConnect helped me find a great co-founder for my startup!",
  ...
  },
  {
    ...
    text: "I found my dream development team thanks to DevConnect!",
      ...
      <section className="content-container space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="mx-auto max-w-2xl text-body-base text-neutral-400">
            DevConnect combines discovery, collaboration, and communication in a single delightful experience so you can ship faster with people you trust.
          </p>
        </div>
        ...
        >
          ...
          <div className="relative mx-auto flex max-w-2xl flex-col items-center gap-6 py-12">
            ...
            <p className="text-body-base text-neutral-100">
              Join thousands of developers already connecting, collaborating, and building together on DevConnect.
            </p>
